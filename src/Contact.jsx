import React, { useState, inputEvent } from "react";
...
const Contact = () => {
  ...
  const formSubmit = (e) => {
    e.preventDefault();
    alert(`Your name is ${data.fullname}. Your mobile number is ${data.phone} and email is ${data.email}, Here is your message:- ${data.msg}`)
  };
